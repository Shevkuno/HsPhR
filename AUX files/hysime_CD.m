function [varargout]=hysime_CD(varargin)
%
...
Py = real(diag(E'*Ry*E)); %equation (23)
Pn = real(diag(E'*Rn*E)); %equation (24)
balance_in_MSE=2.;  %% equal to 2 in JOSE paper
cost_F = -Py + balance_in_MSE*Pn;    %equation (22)
kf = sum(cost_F<0);
...
if nargout == 2, varargout(2) = {Ek};end %Instead of outputing Ek matrix which columns are the eigenvectors that span
